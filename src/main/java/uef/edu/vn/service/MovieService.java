...
public interface MovieService {
    ...
    boolean updateMovieBasePrice(int movieId, double basePrice);
    ...
    List<Movie> getMoviesWithShowtimesForCalendarDate(java.sql.Date date);
    List<Movie> searchMoviesWithShowtimesIn7Days(String keyword, String genre);
