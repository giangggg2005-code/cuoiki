...
public interface BookingService {
    ...
    int processCustomerCheckout(int userId, int showtimeId, String[] seatNames,
                                String paymentMethod, Integer paymentId, String cardNumber,
                                String pinCode, String qrTransactionCode, Integer qrPaymentUserId);

    Map<String, Object> getCustomerBookingDetail(int bookingId, int userId);
}