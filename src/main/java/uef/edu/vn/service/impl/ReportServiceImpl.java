...
public class ReportServiceImpl implements ReportService {
 ...
 @Override
    ...
    public Map<String, Object> getStaffDashboardData() {
        Map<String, Object> data = new HashMap<>();
        try {
            data.put("summary", reportRepository.getTodayStaffSummary());
            data.put("todayShowtimes", reportRepository.getTodayShowtimesDashboard(20));
            data.put("revenueByShift", reportRepository.getTodayRevenueByShift());
            data.put("ticketSalesByMovie", reportRepository.getTodayTicketSalesByMovie(10));
            data.put("recentBookings", reportRepository.getRecentBookingsToday(10));
        } catch (Exception e) {
            throw new ReportException("Lỗi tải dữ liệu dashboard staff: " + e.getMessage(), e);
        }
        return data;
    }
}