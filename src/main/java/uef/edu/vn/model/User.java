...
public class User {
    ...
    @AssertTrue(message = "Lỗi logic: Trạng thái tài khoản không hợp lệ! (Chỉ chấp nhận: Active, Inactive, Banned, Locked, Unverified)")
    public boolean isStatusValid() {
        if (this.status != null) {
            List<String> validStatuses = Arrays.asList("Active", "Inactive", "Banned", "Locked", "Unverified");
