...
public class Seat {
    ...
    @Max(value = 30, message = "Vị trí hàng vượt quá giới hạn tối đa của phòng chiếu (Tối đa 30)")
    private int rowPos;

    @Min(value = 1, message = "Vị trí cột (Column) phải lớn hơn hoặc bằng 1")
    @Max(value = 30, message = "Vị trí cột vượt quá giới hạn tối đa của phòng chiếu (Tối đa 30)")
    private int colPos;
