...
public class Room {
    ...
    @Max(value = 30, message = "Số hàng ghế không thực tế (Tối đa 30 hàng để đảm bảo tầm nhìn của rạp)")
    private int totalRows;

    @Min(value = 1, message = "Số cột ghế (Columns) phải có ít nhất là 1 cột")
    @Max(value = 30, message = "Số cột ghế không thực tế (Tối đa 30 cột để vừa vặn với kích thước màn hình)")
