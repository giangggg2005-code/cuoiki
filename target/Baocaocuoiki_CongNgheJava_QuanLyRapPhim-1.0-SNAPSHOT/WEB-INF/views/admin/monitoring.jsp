        ...
        <div class="bg-[#1a1c23] border border-gray-800/60 rounded-2xl p-4 flex flex-col shadow-xl">
            ...
            <div class="overflow-y-auto custom-scrollbar max-h-80 pr-1 space-y-2.5">
                <c:forEach var="staff" items="${newStaff}">
                    <a href="${pageContext.request.contextPath}/admin/staffs/detail/${staff.id_User}"
                       class="local-filter-item card-glowing-hover block bg-[#0b0c10] p-3 rounded-xl border border-gray-800/80 flex justify-between items-center hover:border-amber-500/40 hover:bg-gradient-to-r hover:from-[#0b0c10] hover:to-amber-950/10 transition cursor-pointer group"
                        ...
                        <div class="truncate mr-2">
                            <p class="text-white text-xs font-bold truncate group-hover:text-amber-400 transition">${staff.fullName}</p>
        ...
        <div class="bg-[#1a1c23] border border-gray-800/60 rounded-2xl p-4 flex flex-col shadow-xl">
            ...
            <div class="overflow-y-auto custom-scrollbar max-h-80 pr-1 space-y-2.5">
                <c:forEach var="update" items="${recentUpdates}">
                    <c:set var="updateDetailUrl" value="${pageContext.request.contextPath}/admin/staffs/detail/${update.id_User}" />
                    <c:if test="${update.roleName == 'CUSTOMER'}">
                        <c:set var="updateDetailUrl" value="${pageContext.request.contextPath}/admin/customers/detail/${update.id_User}" />
                    </c:if>
                    <a href="${updateDetailUrl}"
                       class="local-filter-item card-glowing-hover block bg-[#0b0c10] p-3 rounded-xl border border-gray-800/80 flex justify-between items-center hover:border-green-500/40 hover:bg-gradient-to-r hover:from-[#0b0c10] hover:to-green-950/10 transition cursor-pointer group"
                        ...
                        <div class="truncate mr-2">
                            <p class="text-white text-xs font-bold truncate group-hover:text-green-400 transition">${update.fullName}</p>
        ...
        <div class="bg-[#1a1c23] border border-gray-800/60 rounded-2xl p-4 flex flex-col shadow-xl">
            ...
            <div class="overflow-y-auto custom-scrollbar max-h-80 pr-1 space-y-2.5">
                <c:forEach var="role" items="${roleAssignments}">
                    <c:set var="roleDetailUrl" value="${pageContext.request.contextPath}/admin/staffs/detail/${role.id_User}" />
                    <c:if test="${role.roleName == 'CUSTOMER'}">
                        <c:set var="roleDetailUrl" value="${pageContext.request.contextPath}/admin/customers/detail/${role.id_User}" />
                    </c:if>
                    <a href="${roleDetailUrl}" 
