                    ...
                    <tr class="hover:bg-white/[0.02] transition">
                        ...
                        <td class="p-4 text-center">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <c:choose>
                                <c:when test="${movie.status == 'Closed'}">
                                    <span class="w-8 h-8 rounded-lg bg-gray-500/10 text-gray-500 cursor-not-allowed flex items-center justify-center" title="Phim Closed — không thể chỉnh sửa"><i class="fas fa-pen"></i></span>
                                    <span class="w-8 h-8 rounded-lg bg-gray-500/10 text-gray-500 cursor-not-allowed flex items-center justify-center" title="Phim Closed — không thể xóa"><i class="fas fa-trash"></i></span>
                                </c:when>
                                <c:otherwise>
